...
INNER JOIN sparepart ON adminservise.id_sparepart= sparepart.id_sparepart ORDER BY id_admin ");
...
<html lang="en">
  ...
  <body ><br>
    ...
    <h2 class="text-center"style="color:white;">DATA BIAYA PERBAIKAN </h2>

        <form action="fungsi/add_biayaperbaikan.php" method="POST" enctype="multipart/form-data" id="from">
    ...
    <option selected>Masukkan keluhan</option>
    ...
    <input type="date" class="form-control" id="tgl_perbaikan" name="tgl_perbaikan" placeholder="MASUKKAN TGL PERBAIKAN" >   <br>
   ...
   <label for="jenis_barang" class="form-label" style="color:white;">Jenis Sparepart </label>
    ...
    <input type="text" class="form-control" id="biaya_lain" name="biaya_lain" placeholder="MASUKKAN BIAYA LAIN" ><br>

    <label  for="total_biaya" class="form-label" style="color:white;">Total biaya </label>
    <input type="text" class="form-control" id="total_biaya" name="total_biaya" placeholder="MASUKKAN TOTAL BIAYA" >   
...
<a href="biaya_perbaikan.php"><button type="reset" class="btn btn-dark" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
