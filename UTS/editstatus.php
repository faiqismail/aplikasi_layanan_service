...
<div class="container" id="register"><br>
    <h2 class="text-center"style="color:white;">EDIT STATUS </h2>

        <form action="fungsi/editstatus.php" method="POST" enctype="multipart/form-data" id="from">
...
<button type="reset" class="btn btn-dark" onclick="window.location.href='tugaskerja.php'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
