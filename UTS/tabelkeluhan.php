...
<html lang="en">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li  ><a href="homepelanggan.php">Pelanggan</a></li>
          <li ><a href="keluhan.php">Lapor Keluhan</a></li>
          <li class="active"><a href="tabelkeluhan.php">Status Keluhan</a></li>
  ...
  <h1 class="text-center">Status Keluhan</h1><br>
