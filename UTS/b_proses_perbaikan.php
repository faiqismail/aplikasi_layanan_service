...
INNER JOIN adminservise ON perbaikan.id_admin = adminservise.id_admin ORDER BY id_perbaikan ");
...
<html lang="en">
  ...
  <div class="container" id="register"><br>
    <h2 class="text-center"style="color:white;">DATA PROSES PERBAIKAN </h2>

        <form action="fungsi/addprosesperbaikan.php" method="POST" enctype="multipart/form-data" id="from">
       
  
    <label  for="nama_pelanggan" class="form-label" style="color:white;">Nama Pelanggan</label>
    <select type="text" id="nama_pelanggan" name="id_pelanggan" class="form-select" aria-label="Default select example"  >
    ...
    <br><label for="nama_perangkat" class="form-label" style="color:white;">Nama Perangkat</label>
    <select type="text"  id="nama_perangkat" name="id_keluhan" class="form-select" aria-label="Default select example" >
    <option selected>Nama Perangkat</option>
   ...
   <label for="tgl_perbaikan" class="form-label" style="color:white;">tgl_perbaikan </label>
     ...
     <option selected>TGL perbaikan</option>
    ...
    <label for="nama_pegawai" class="form-label" style="color:white;">nama_pegawai </label>
     <select type="text" id="nama_pegawai" name="id_pegawai"  class="form-select" aria-label="Default select example">
    ...
    <input type="text" class="form-control" id="status" name="status" placeholder="MASUKKAN Status" ><br>
